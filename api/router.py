...
query_api.add_url_rule('/query6', view_func=Query6API.as_view("Store wise top three products"))
query_api.add_url_rule('/query7', view_func=Query7API.as_view("X days"))
query_api.add_url_rule('/query8', view_func=Query8API.as_view("Worst season per product"))
query_api.add_url_rule('/query9', view_func=Query9API.as_view("Division wise total sales"))
query_api.add_url_rule('/query10', view_func=Query10API.as_view("Average sales per store monthly"))
