...
query_api.add_url_rule('/query6', view_func=Query6API.as_view("Store wise top 3 purchased products"))
...
query_api.add_url_rule('/query9', view_func=Query9API.as_view("Division wise total sales of items"))
query_api.add_url_rule('/query10', view_func=Query10API.as_view("Month wise average sales of products"))